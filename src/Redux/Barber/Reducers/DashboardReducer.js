import {
  BARBER_CONNECT_SALON_FAIL,
  BARBER_CONNECT_SALON_REQ,
  BARBER_CONNECT_SALON_SUCCESS,
  BARBER_DASHBOARD_SALON_INFO_FAIL,
  BARBER_DASHBOARD_SALON_INFO_REQ,
  BARBER_DASHBOARD_SALON_INFO_SUCCESS,
  CHANGE_BARBER_ONLINESTATUS_FAIL,
  CHANGE_BARBER_ONLINESTATUS_REQ,
  CHANGE_BARBER_ONLINESTATUS_SUCCESS,
  CONNECT_SALON_LIST_FAIL,
  CONNECT_SALON_LIST_REQ,
  CONNECT_SALON_LIST_SUCCESS,
  GET_BARBER_SALON_LOGO_FAIL,
  GET_BARBER_SALON_LOGO_REQ,
...
export const connectSalonListReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "CONNECT_SALON_LIST_RESET":
      return initialState; // ← RESET WHOLE STATE
