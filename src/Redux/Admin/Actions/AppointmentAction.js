...
export const getAdminAppointmentListSalonIdAction = (appointmentData, selectedDay) => async (dispatch) => {
    try {
        dispatch({ type: GET_ALL_APPOINTMENTSLIST_REQ })

        const { data } = await api.post("/api/appointments/getAppointmentListBySalonIdAndAppointmentDate", {
