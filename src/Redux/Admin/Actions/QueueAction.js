...
import {
  ADMIN_BARBER_SERVED_QUEUE_REQ,
  ADMIN_BARBER_SERVED_QUEUE_SUCCESS,
  ADMIN_BARBER_SERVED_QUEUE_FAIL,
  ADMIN_CANCEL_QUEUE_REQ,
  ADMIN_CANCEL_QUEUE_SUCCESS,
  ADMIN_CANCEL_QUEUE_FAIL,
  GET_ALL_QUEUELIST_SUCCESS,
...
export const adminCancelQueueAction =
  (
    canceldata,
    salonId,
    setChoosebarbermodalopen,
