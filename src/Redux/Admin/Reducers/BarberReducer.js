...
export const getBarberDashboardReducer = (state = {}, action) => {
    switch (action.type) {
        case GET_ALL_BARBER_DASHBOARD_REQ:
            return {
                ...state,
                loading: true,
                resolve: false
            };
        case GET_ALL_BARBER_DASHBOARD_SUCCESS:
            return {
                ...state,
                loading: false,
                resolve: true,
        ...
        case GET_ALL_BARBER_DASHBOARD_FAIL:
            return {
                ...state,
                loading: false,
                resolve: false,
...
export const adminSendNotificationReducer = (state = {}, action) => {
    switch (action.type) {
        case ADMIN_SEND_NOTIFICATION_REQ:
            return {
                ...state,
                loading: true,
                resolve: false
            };
        case ADMIN_SEND_NOTIFICATION_SUCCESS:
            return {
                ...state,
                loading: false,
                resolve: true,
        ...
        case ADMIN_SEND_NOTIFICATION_FAIL:
            return {
                ...state,
                loading: false,
                resolve: false,
