...
// const containerStyle = { width: "100%", height: "30rem" };
...
//     console.log("Selected Lat/Lng:", newPos);
//   };
...
//         console.log("Selected from search:", newPos);
//       });
//     }
//   }, [isLoaded]);
...
//           <Marker
//             position={markerPosition}
//             draggable={true} // 🎯 bonus: drag marker
//             onDragEnd={(e) => {
//               const newPos = {
//                 lat: e.latLng.lat(),
//                 lng: e.latLng.lng(),
...
//           <strong>Lat:</strong> {markerPosition.lat} <br />
//           <strong>Lng:</strong> {markerPosition.lng}
//         </div>
//       )}
//     </div>
//   );
...
const CreateSalon = () => {
  ...
  // 📍 Reverse Geocoding (lat/lng → address + pincode)
      ...
      {markerPosition && (
        ...
        >
          ...
          <div style={{ display: "flex", gap: "6px" }}>
            <span style={{ fontWeight: "600", color: "#555" }}>Lat:</span>
            <span>{markerPosition.lat.toFixed(6)}</span>
          </div>

          {/* Longitude */}
          <div style={{ display: "flex", gap: "6px" }}>
            <span style={{ fontWeight: "600", color: "#555" }}>Lng:</span>
            <span>{markerPosition.lng.toFixed(6)}</span>
          </div>

          {/* Address */}
          <div style={{ display: "flex", gap: "6px", minWidth: "200px" }}>
            <span style={{ fontWeight: "600", color: "#555" }}>Address:</span>
            <span style={{ color: "#333" }}>{address || "—"}</span>
          </div>

          {/* Pincode */}
          <div style={{ display: "flex", gap: "6px" }}>
            <span style={{ fontWeight: "600", color: "#555" }}>Pincode:</span>
            <span>{pincode || "—"}</span>
          </div>
        </div>
      )}
