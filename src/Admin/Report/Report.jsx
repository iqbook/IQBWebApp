...
const Report = () => {
  ...
  const GRADIENTS = [
    { key: "a", from: "#BFDBFE", to: "#93C5FD" }, // Blue 200 → 300
    { key: "b", from: "#A7F3D0", to: "#6EE7B7" }, // Emerald 200 → 300
    { key: "c", from: "#FDE68A", to: "#FCD34D" }, // Amber 200 → 300
    { key: "d", from: "#DDD6FE", to: "#C4B5FD" }, // Violet 200 → 300
    { key: "e", from: "#FBCFE8", to: "#F9A8D4" }, // Rose 200 → 300
    { key: "f", from: "#99F6E4", to: "#5EEAD4" }, // Teal 200 → 300
    { key: "g", from: "#FED7AA", to: "#FDBA74" }, // Orange 200 → 300
  ];
